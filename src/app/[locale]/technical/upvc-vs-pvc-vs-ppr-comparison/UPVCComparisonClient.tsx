  ...
  return (
    <>
      ...
      <article className="min-h-screen bg-white">
        {/* Hero Section */}
        <header className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-[150px] md:pt-[180px] pb-16">
          <div className="w-full max-w-[90%] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-4 text-sm mt-8">
              <span className="bg-blue-700/70 border border-blue-500/30 px-3 py-1 rounded-full">
        ...
        <div className="w-full max-w-[90%] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-yellow-400 pl-4">
                  ...
                  <p className="text-blue-100">Choose <strong className="text-white">UPVC</strong> meeting
                    international standards (BS EN, ISO, ASTM). 50-100 year lifespan minimizes replacement costs.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                ...
                and ISO standards, as well as PPR pipes for hot water applications. Our technical
            ...
            <div className="space-y-3">
              {comparisonFAQs.map((faq) => (
                <details key={faq.id} className="group border border-gray-200 rounded-lg overflow-hidden">
                  <summary className="flex items-center justify-between px-6 py-4 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 transition-colors">
                    <span>{faq.question}</span>
                    <svg className="w-5 h-5 text-gray-500 shrink-0 ml-4 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <aside className="border-t pt-8" aria-label="Related technical guides">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link href="/technical/upvc-installation-best-practices"
                className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  Certified to BS EN 1452, DIN 8062, ASTM, and ISO international standards.
                </p>
              </div>
            </div>
          </div>
