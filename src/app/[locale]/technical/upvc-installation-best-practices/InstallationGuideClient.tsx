  ...
  return (
    <>
      ...
      <article className="min-h-screen bg-white">
        {/* Hero Section */}
        <header className="bg-gradient-to-br from-green-900 via-green-800 to-green-900 text-white pt-[150px] md:pt-[180px] pb-16">
          <div className="w-full max-w-[90%] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-4 text-sm mt-8">
              <span className="bg-green-700/70 border border-green-500/30 px-3 py-1 rounded-full">
