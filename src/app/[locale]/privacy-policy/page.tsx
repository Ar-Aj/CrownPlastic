...
export const metadata: Metadata = {
  title: 'Privacy Policy | Crown Plastic Pipes / Fittings UAE',
  description:
    'Read the privacy policy of Crown Plastic Pipes Factory L.L.C. Learn how we collect, use, and protect your personal data when you visit our website or submit inquiries.',
  alternates: {
    canonical: 'https://crownplasticuae.com/privacy-policy',
  },
  openGraph: {
    title: 'Privacy Policy | Crown Plastic Pipes',
    description:
      'Privacy policy for Crown Plastic Pipes Factory L.L.C. — how we handle your data.',
    url: 'https://crownplasticuae.com/privacy-policy',
  },
};
