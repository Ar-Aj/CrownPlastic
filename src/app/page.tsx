  ...
  return (
    <>
      ...
      <header className="relative min-h-[70vh] md:min-h-[80vh] flex items-center bg-white">
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 2xl:px-[10vw] relative z-10 py-12 md:py-16">
...
function ProductCategoriesSection() {
  ...
  return (
    <section ref={ref} className="py-12 md:py-16 bg-white relative overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 2xl:px-[10vw] relative z-10">
        <SectionHeader
          label="Our Products"
