        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('contact.get_in_touch')}</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">{t('contact.factory_address')}</h3>
              ...
              <div className="mt-8 space-y-4">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-primary/10 flex flex-col items-center justify-center">
                    ...
                    <span className="text-primary font-medium">{t('contact.view_map')}</span>
                    <span className="text-xs text-gray-600 mt-1">{t('contact.get_directions')}</span>
                  </div>
                </a>
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-50 p-8 rounded-2xl">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('contact.send_message')}</h2>
      ...
      <section id="careers" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimateOnScroll animation="fade-up">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">{t('contact.departments')}</h2>
          </AnimateOnScroll>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { dept: t('contact.dept_sales'), email: 'sales@crownplasticuae.com', iconName: 'phone' as IconName },
              { dept: t('contact.dept_technical'), email: 'technical@crownplasticuae.com', iconName: 'wrench' as IconName },
              { dept: t('contact.dept_careers'), email: 'careers@crownplasticuae.com', iconName: 'users' as IconName },
            ].map((item, i) => (
