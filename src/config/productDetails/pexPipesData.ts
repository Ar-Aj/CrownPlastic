/**
 * PEX Pipes - Product Detail Configuration
 * Phase 2.11 — 1 sub-product: pex-pipes-pn-12-5-pn-20 (Pillar Page)
 * SEO: UAE/GCC/Dubai luxury villa, underfloor heating, MEP keywords injected.
 * Includes new data schemas: technicalProperties + systemAdvantages.
 */

import { type ProductDetailConfig } from '@/types/productDetail';

export const pexPipesPn125Pn20: ProductDetailConfig = {
  ...
  features: [
    ...
    'Scale and Corrosion Free: Advanced materials prevent internal build-up and environmental corrosion.',
    'High Physical Stability: Ensures consistent performance and pressure retention under GCC climatic extremes.',
    'Manifold System Integration: Optimized for mobile installations to accurately select outlets for hot and cold circuits.',
  ],
  featuresAr: [
    'مقاومة حرارة عالية: مصممة للحفاظ على السلامة الهيكلية في تطبيقات المياه الساخنة حتى 95°C.',
    'مرونة فائقة: مصممة للتمرير السهل في هياكل الأرضيات والجدران عبر تخطيطات مرنة معقدة.',
    'مطابقة للمعايير الألمانية: مصنعة بالكامل وفق متطلبات DIN 16892 و DIN 16893.',
    'خالية من الترسبات والتآكل: مواد متقدمة تمنع التراكم الداخلي والتآكل البيئي.',
  ...
  technicalPropertiesAr: [
    { property: 'المادة الأساسية', value: 'PE-X (بولي إيثيلين متشابك)' },
    { property: 'معيار التصنيع', value: 'DIN 16892 و DIN 16893' },
    { property: 'أقصى درجة حرارة تشغيل', value: '95°C' },
    { property: 'تصنيفات الضغط', value: 'PN 12.5 و PN 20' },
    { property: 'تصنيفات SDR', value: 'SDR 11.08 و SDR 7.4' },
    { property: 'العمر الافتراضي المقدر', value: '50 عاماً كحد أدنى في الظروف المصنفة' },
  ...
  systemAdvantages: [
    ...
    'Chemical resistance that prevents deterioration when in contact with building materials like cement and lime.',
  ],
  systemAdvantagesAr: [
    'عملية تركيب سريعة وبسيطة تقلل تكاليف عمالة MEP الإجمالية في دبي وأبوظبي.',
    'تقنية تأثير الذاكرة تسمح للأنابيب بالتكيف مع الهياكل المرنة وأنظمة المشعاع المتنقلة.',
  ...
  applications: [
    ...
    'Specialized plumbing networks for laboratories, cinemas, and large-scale sports halls.',
  ],
  applicationsAr: [
    'أنظمة التدفئة تحت الأرضية والجدارية والسقفية للفلل السكنية الفاخرة.',
    'شبكات نقل المياه الساخنة والباردة الصالحة للشرب في المراكز التجارية.',
  ...
  pipesTables: [
      ...
      columns: [
        { key: "nominal_od", label: "Nominal OD (mm)" },
        { key: "wt_pn12_5", label: "Wall Thickness PN 12.5 (mm)" },
        { key: "wt_pn20", label: "Wall Thickness PN 20 (mm)" }
      ],
      rows: [
        { "nominal_od": "16", "wt_pn12_5": "1.8", "wt_pn20": "2.2" },
        { "nominal_od": "20", "wt_pn12_5": "1.9", "wt_pn20": "2.8" },
        { "nominal_od": "25", "wt_pn12_5": "2.3", "wt_pn20": "3.5" },
        { "nominal_od": "32", "wt_pn12_5": "2.9", "wt_pn20": "4.4" }
      ]
    }
  ],
  fittings: [],
  ...
  dosDonts: {
    dos: [
      'Select manifold outlets based precisely on the number of hot and cold water tops in each circuit.',
      'Ensure all PEX installations follow the mobile installation method for maximum radiator efficiency.',
      'Reference DIN 16893 working condition tables to determine permissible pressure for specific operating temperatures.',
      'Use dedicated Red and Blue protective sleeves to clearly differentiate hot and cold water lines.',
    ],
    donts: [
      'Do not exceed the maximum permissible working pressure for peak temperature service (e.g., 5.5 bar at 95°C for PN 12.5).',
      'Avoid utilizing PEX piping that does not meet the general quality requirements of DIN 16892.',
      'Do not ignore mandatory cooling times or rotate joints during associated fusion welding for fitting connections.',
      "Don't overlook elongation calculations caused by temperature differences between installation and operation.",
    ],
  },
  dosDontsAr: {
    dos: [
      'اختر مخارج المشعب بناءً على عدد صنابير المياه الساخنة والباردة في كل دائرة بدقة.',
      'تأكد أن جميع تركيبات PEX تتبع طريقة التركيب المتنقل لأقصى كفاءة للمشعاع.',
      'ارجع إلى جداول ظروف العمل DIN 16893 لتحديد الضغط المسموح عند درجات حرارة التشغيل المحددة.',
      'استخدم أغطية حماية حمراء وزرقاء مخصصة للتمييز الواضح بين خطوط المياه الساخنة والباردة.',
    ],
    donts: [
      'لا تتجاوز أقصى ضغط عمل مسموح لخدمة درجة الحرارة القصوى (مثل 5.5 بار عند 95°C لـ PN 12.5).',
      'تجنب استخدام أنابيب PEX لا تلبي متطلبات الجودة العامة لـ DIN 16892.',
      'لا تتجاهل أوقات التبريد الإلزامية أو تدوير المفاصل أثناء لحام الانصهار لتوصيلات التركيبات.',
