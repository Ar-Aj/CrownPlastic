...
export const upvcDrainagePipesBs5255BsEn1329: ProductDetailConfig = {
  ...
  featuresAr: SHARED_FEATURES_AR,

  applications: SHARED_APPLICATIONS,
  applicationsAr: SHARED_APPLICATIONS_AR,
  ...
  dosDontsAr: SHARED_DOS_DONTS_AR,
};
