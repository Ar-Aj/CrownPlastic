...
export const productCategories: ProductCategory[] = [
  {
    ...
    subProducts: [
      {
        slug: 'pipes-metric',
        name: 'UPVC Pressure Pipes - Metric Series',
        standards: ['ISO 4422', 'BS EN 1452', 'DIN 8061', 'DIN 8062'],
        shortDescription: 'Metric series pressure pipes for potable water supply systems with excellent chemical resistance.',
        features: ['Lead-free', 'Corrosion resistant', 'Long service life', 'Easy installation'],
      },
      {
        slug: 'pipes-inch',
        name: 'UPVC Pressure Pipes - Inch Series',
        standards: ['BS 3505', 'BS 3506', 'ASTM D1785', 'ASTM D2241'],
        shortDescription: 'Imperial inch series pressure pipes designed for water distribution networks.',
        features: ['High pressure rating', 'UV stabilized', 'Leak-proof joints'],
      },
      {
        slug: 'fittings',
        name: 'UPVC Pressure Fittings',
        standards: ['DIN 8063', 'BS EN 14523', 'BS 4346 PN15', 'ASTM D2466 SCH-40'],
        shortDescription: 'Complete range of fittings including elbows, tees, couplers, and adapters for pressure applications.',
    ...
    subProducts: [
      {
        ...
        name: 'Above Ground Drainage Pipes',
        standards: ['BS 5255', 'BS 4514', 'BS EN 1329'],
        shortDescription: 'Soil and waste discharge pipes for internal and external above-ground drainage systems.',
      ...
      },
      {
        ...
        name: 'Non-Standard Drainage Pipes',
  ...
  },
  {
    ...
    subProducts: [
      ...
      },
      {
        ...
        name: 'Special Duct Pipes (D54/D56/D57)',
        standards: ['D54', 'D56', 'D57'],
        shortDescription: 'Special specification duct pipes for unique project requirements.',
        features: ['Custom specifications', 'Project-specific design'],
      },
      {
        slug: 'pipes-telecom',
        name: 'Telecom Duct Pipes',
  ...
  },
  {
    ...
    subProducts: [
      {
        slug: 'round-heavy',
        name: 'Round Heavy Gauge Conduit',
      ...
      {
        slug: 'round-medium',
        name: 'Round Medium Gauge Conduit',
      ...
      {
        slug: 'round-light',
        name: 'Round Light Gauge Conduit',
  ...
  },
  {
    ...
    subProducts: [
      ...
      },
      {
        ...
        name: 'LLDPE/LDPE Drip Irrigation',
