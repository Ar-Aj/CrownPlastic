...
export function HomeVideoCarousel() {
  ...
  const SLIDES: VideoSlide[] = [
    {
      ...
      title: t('home.video_carousel.slides.drainage.title'),
      description: t('home.video_carousel.slides.drainage.description'),
      ctaLabel: t('home.video_carousel.slides.drainage.cta'),
      ctaHref: '/products/upvc-drainage-pipes',
    },
    {
      src: '/videos/home1st/pvc_high_pressure_1sthome.mp4',
    ...
    },
    {
      ...
      title: t('home.video_carousel.slides.ppr.title'),
      description: t('home.video_carousel.slides.ppr.description'),
      ctaLabel: t('home.video_carousel.slides.ppr.cta'),
    ...
    },
    {
      ...
      title: t('home.video_carousel.slides.conduit.title'),
      description: t('home.video_carousel.slides.conduit.description'),
      ctaLabel: t('home.video_carousel.slides.conduit.cta'),
      ctaHref: '/products/pvc-conduit-pipes',
    },
  ];
  ...
  return (
    <section
      className="relative w-full bg-slate-900 overflow-hidden pt-[140px] lg:pt-[210px] 2xl:pt-[230px] pb-10 lg:pb-[53px] 2xl:pb-[58px]"
            ...
            >
              ...
              <div className="mx-auto lg:max-w-5xl xl:max-w-6xl min-[1800px]:max-w-none min-[1800px]:px-16">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-[minmax(0,3fr)_minmax(0,4fr)] min-[1800px]:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] gap-6 lg:gap-10 xl:gap-14 min-[1800px]:gap-24 items-center">
                  ...
                  {/* LEFT: Video Player - FADE ONLY */}
                  <motion.div
                    className="w-full flex justify-center lg:justify-end lg:self-center"
                    variants={{
                      initial: { opacity: 0 },
                  ...
                  {/* RIGHT: Text Box - SLIDE & FADE */}
                  <motion.div
                    className="w-full flex justify-center lg:justify-start lg:self-center"
                    variants={{
