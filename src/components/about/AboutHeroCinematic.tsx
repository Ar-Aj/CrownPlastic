      ...
      >
        ...
        >
          ...
          <div className="relative z-10 h-full pt-28 lg:pt-32">
            <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-12 h-full">
...
function MobileHero({ prefersReducedMotion }: MobileHeroProps) {
  ...
  return (
    <section className="relative bg-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-10 xl:px-12 py-10 md:py-12">
        {/* Breadcrumb */}
