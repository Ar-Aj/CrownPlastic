...
const CATEGORY_META: Record<CategoryId, CategoryMeta> = {
  ...
  'pvc-high-pressure-pipes': { nameEn: 'uPVC High Pressure Pipes / Fittings', nameAr: 'أنابيب / تجهيزات ضغط عالي PVC', nameFr: 'Tuyaux / Raccords uPVC Haute Pression', primaryStandard: 'BS EN 1452 / ISO 4422-2:1996' },
  'pvc-high-pressure-fittings': { nameEn: 'uPVC High Pressure Fittings', nameAr: 'وصلات ضغط عالي PVC', nameFr: 'Raccords uPVC Haute Pression', primaryStandard: 'DIN 8063 / BS EN 1452:3' },
  ...
  'pvc-duct-pipes': { nameEn: 'uPVC Duct Pipes / Fittings', nameAr: 'أنابيب / تجهيزات مجاري PVC', nameFr: 'Tuyaux / Raccords de Gaine uPVC', primaryStandard: 'NEMA TC 2 / DIN 8062' },
  'pvc-duct-fittings': { nameEn: 'uPVC Duct Fittings', nameAr: 'وصلات مجاري PVC', nameFr: 'Raccords de Gaine uPVC', primaryStandard: 'Crown Specification' },
  'pvc-conduit-pipes': { nameEn: 'uPVC Conduit Pipes / Fittings', nameAr: 'أنابيب / تجهيزات قنوات PVC', nameFr: 'Tuyaux / Raccords Conduit uPVC', primaryStandard: '1250N / 750N / SCH 40' },
